...
// ToGoHTMLMetaTags generates the HTML meta tags for the Open Graph Music Radio Station as a string for Go's `html/template`.
func (mrs *MusicRadioStation) ToGoHTMLMetaTags() string {
	mrs.ensureDefaults()
