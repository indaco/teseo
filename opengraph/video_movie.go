...
// ToGoHTMLMetaTags generates the HTML meta tags for the Open Graph Video Movie as a string for Go's `html/template`.
func (vm *VideoMovie) ToGoHTMLMetaTags() string {
	vm.ensureDefaults()
