...
// ToGoHTMLMetaTags generates the HTML meta tags for the Open Graph Music Playlist as a string for Go's `html/template`.
func (mp *MusicPlaylist) ToGoHTMLMetaTags() string {
	mp.ensureDefaults()
