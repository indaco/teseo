...
// ToGoHTMLMetaTags generates the HTML meta tags for the Open Graph Product Group as a string for Go's `html/template`.
func (pg *ProductGroup) ToGoHTMLMetaTags() string {
	pg.ensureDefaults()
